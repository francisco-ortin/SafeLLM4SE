...
- Document all the attributes in classes with a single line comment describing their purpose.
- Annotate all function parameters, return values, variables, and class attributes with Python type hints.
- All methods and functions must document in their docstrings what they return, if anything, and which exceptions they may raise.
