...
from reporting.cli import MandatoryAwareDefaultsHelpFormatter
from compare.models import ComparisonSettings


def build_parser() -> argparse.ArgumentParser:
    """Build the command-line parser used by compare.py.
    ...
    parser.add_argument(
        ...
        help="Experimental design used to compare both distributions.",
    )
    parser.add_argument(
        "--confidence-level",
        default=0.95,
